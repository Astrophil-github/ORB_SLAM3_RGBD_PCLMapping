...
int main(int argc, char **argv)
{
    ...
    message_filters::Subscriber<sensor_msgs::Image> rgb_sub(nh, "/image_raw", 100);    // LX
    message_filters::Subscriber<sensor_msgs::Image> depth_sub(nh, "/camera/depth/image", 100);    // LX
