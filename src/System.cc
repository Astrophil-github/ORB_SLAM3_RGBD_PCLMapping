    ...
    mbActivateLocalizationMode(false), mbDeactivateLocalizationMode(false), mbShutDown(false)
{
    ...
    // Initialize pointcloud mapping  LX
    ...
    mpLocalMapper = new LocalMapping(this, mpAtlas, mpPointCloudMapping, mSensor==MONOCULAR || mSensor==IMU_MONOCULAR,
...
void System::Shutdown()
{
    ...
    // LX
    // sleep(1000);
    mpPointCloudMapping->shutdown();        // LX
    /*if(mpViewer)
    {
        mpViewer->RequestFinish();
        while(!mpViewer->isFinished())
