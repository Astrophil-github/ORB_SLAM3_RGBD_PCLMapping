...
// for pointcloud mapping and viewing   LX
...
public:
    ...
    LocalMapping(System* pSys, Atlas* pAtlas, shared_ptr<PointCloudMapping> pPointCloud, const float bMonocular, bool bInertial, const string &_strSeqName=std::string());
